...
public class LectureWorkbook {
	...
	private void resetLecturesInWorkbook() {
	...
	private XSSFRichTextString lectureToRichText(XSSFFont mainFont, Map<XSSFFont, Integer[]> lectureNameFonts,
			Lecture lecture) {
